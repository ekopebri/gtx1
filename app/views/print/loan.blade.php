...
<div class="row">
  <div class="col-lg-12">
    <h3 class="sub-header">Permintaan Pinjaman Dana Bulan <?php $monthNum = $month; $monthName = date("F", mktime(0, 0, 0, $monthNum, 10)); echo $monthName; //output: May?> {{$year}} (Dalam jutaan)</h3>
